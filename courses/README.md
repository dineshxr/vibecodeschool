...
Three free interactive courses — one per agent. The recommended order is top to bottom;
see the [full roadmap](../roadmap/README.md) for why.

| # | Course | Level | Size | Time |
|---|--------|-------|------|------|
